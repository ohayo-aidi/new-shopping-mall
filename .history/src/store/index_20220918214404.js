...
const getLocalCartList = () => {
  ...
  if (typeof localStorage.cartList !== 'undefined') { // 避免直接使用JSON.parse 引起“JSON.parse(<anonymous>)”
...
export default Vuex.createStore({
  ...
  mutations: {
    ...
    changeShopName (state, payload) {
      ...
      shopInfo.shopName = shopName // shopInfo.shopName 而不是 name 搞了半天
      state.cartList[shopId] = shopInfo
      setLocalCartList(state)
    },
    clearCartData (state, shopId) {
      state.cartList[shopId].pro
    }
  },
  actions: {},
  modules: {}
