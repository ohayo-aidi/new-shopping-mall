  ...
  <div class="cart">
    ...
    <div class="product">
      <div class="product__header">
        <div class="product__header__all"></div>
        <div class="product__header__icon"></div>
        <div class="product__header__clear"></div>
      </div>
      <template
...
export default {
  name: "Cart",
  setup(){
    const { total, price, productList, changeCartItemChecked } = useCartEffect()
